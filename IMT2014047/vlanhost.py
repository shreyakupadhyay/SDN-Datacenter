...
class VLANStarTopo( Topo ):
	...
	h1s1v1=self.addHost( 'h1s1v1', cls=VLANHost, vlan=100)
	h2s1v1=self.addHost( 'h2s1v1', cls=VLANHost, vlan=100)
	h3s1v2=self.addHost( 'h3s1v2', cls=VLANHost, vlan=200)
	h4s1v2=self.addHost( 'h4s1v2', cls=VLANHost, vlan=200)
	h1s2v1=self.addHost( 'h1s2v1', cls=VLANHost, vlan=100)
	h2s2v1=self.addHost( 'h2s2v1', cls=VLANHost, vlan=100)
	h3s2v2=self.addHost( 'h3s2v2', cls=VLANHost, vlan=200)
	h4s2v2=self.addHost( 'h4s2v2', cls=VLANHost, vlan=200)
	self.addLink(s1,h1s1v1)
	self.addLink(s1,h2s1v1)
	self.addLink(s1,h3s1v2)
	self.addLink(s1,h4s1v2)
	self.addLink(s2,h1s2v1)
	self.addLink(s2,h2s2v1)
	self.addLink(s2,h3s2v2)
	self.addLink(s2,h4s2v2)
	self.addLink(s1,s2)
	#s1.cmd('ovs-ofctl add-flow s1 icmp,dl_vlan=100,nw_src=10.0.0.2,nw_dst=10.0.0.1,actions=drop')
	#s1.cmd('ovs-ofctl add-flow s1 icmp,dl_vlan=100,nw_src=10.0.0.1,nw_dst=10.0.0.2,actions=drop')
